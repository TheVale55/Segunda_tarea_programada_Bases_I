    ...
    public class InsertarModel : PageModel
    {
        ...
        public void OnPost()
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    string procedureName = "Insertar";
                    using (SqlCommand command = new SqlCommand(procedureName, connection))
                    {

                        command.CommandType = CommandType.StoredProcedure;

                        command.Parameters.AddWithValue("@Codigo", articulosInfo.Codigo);
                        command.Parameters.AddWithValue("@Nombre", articulosInfo.Articulo);
                        command.Parameters.AddWithValue("@Clase", articulosInfo.Clase);
                        command.Parameters.AddWithValue("@Precio", articulosInfo.Precio);
            ...
            mensajeExito = "Producto nuevo agregado exitosamente";
